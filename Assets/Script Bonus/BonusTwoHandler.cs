...
public class LapBonusTwo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bonusImageContainer = root.Q<VisualElement>("Bonus2");
    ...
    {
        if (collision.collider.CompareTag("BonusTwo"))
        {
            if (bonus1Container.style.display != DisplayStyle.Flex && bonus3Container.style.display != DisplayStyle.Flex)
            {
