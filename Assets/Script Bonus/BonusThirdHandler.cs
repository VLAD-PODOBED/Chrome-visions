...
public class LapBonusThird : MonoBehaviour
{
    public UIDocument uiDocument;
    private VisualElement bonusImageContainer;
    private VisualElement bonus1Container;
    ...
    void Start()
    {
        ...
        bonusImageContainer = root.Q<VisualElement>("Bonus3");
        bonus1Container = root.Q<VisualElement>("Bonus1");
    ...
    {
        if (collision.collider.CompareTag("BonusThird"))
        {
            if (bonus1Container.style.display != DisplayStyle.Flex && bonus2Container.style.display != DisplayStyle.Flex)
            {
